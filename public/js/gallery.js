...
Vue.component('gallery-list', __webpack_require__(90));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AddForm_vue__ = __webpack_require__(92);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        index: function index(pageNo, perPage) {
            ...
            axios.get(base_url + "visitor-gallery/?page=" + pageNo + "&perPage=" + perPage).then(function (response) {
        ...
        deleteData: function deleteData(id) {
            var _this = this;
            axios.delete(base_url + 'visitor-gallery/' + id).then(function (response) {
                _this.index(1);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        store: function store() {
            ...
            var _this = this;
            axios.post(base_url + 'visitor-gallery', _this.form).then(function (response) {
        ...
        _c("div", { staticClass: "row form-group" }, [
          ...
          _c("div", { staticClass: "col-12 col-md-9" }, [
            _c("div", { attrs: { id: "app" } }, [
              ...
              _vm._v(" "),
              _vm.errors.hasOwnProperty("my_photo")
                ? _c(
                    "small",
                    {
                ...
                : _vm._e(),
              _vm._v(" "),
              _c("img", { attrs: { src: _vm.my_photo, alt: "" } })
            ])
          ])
        ]),
        _vm._v(" "),
