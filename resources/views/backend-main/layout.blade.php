...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('BackendResource/vendors/jqvmap/dist/jqvmap.min.css') }}">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{ asset('BackendResource/images/admin.jpg') }}" alt="User Avatar">
                        </a>
...
{{--     <script src="{{ asset('BackendResource/vendors/chart.js/dist/Chart.bundle.min.js') }}"></script> --}}
    <script src="{{ asset('BackendResource/assets/js/dashboard.js') }}"></script>
{{--     <script src="{{ asset('BackendResource/assets/js/widgets.js') }}"></script> --}}
    <script src="{{ asset('BackendResource/vendors/jqvmap/dist/jquery.vmap.min.js') }}"></script>
    <script src="{{ asset('BackendResource/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js') }}"></script>
    <script src="{{ asset('BackendResource/vendors/jqvmap/dist/maps/jquery.vmap.world.js') }}"></script>
    <script>
        (function($) {
            "use strict";
